...
urlpatterns = patterns('courses.views',
    ...
    url(r'^class/(?P<course_sec_id>[\d]+)/schedule$', 'offering_schedule', name="offering_schedule"),
    url(r'^class/(?P<course_sec_id>[\d]+)/announcements$', 'offering_announcements', name="offering_announcements"),
    url(r'^class/(?P<course_sec_id>[\d]+)/contact$', 'offering_contact', name="offering_contact"),
    url(r'^class/(?P<course_sec_id>[\d]+)/policies$', 'offering_policies', name="offering_policies"),
    url(r'^class/(?P<course_sec_id>[\d]+)/assignments$', 'offering_assignments', name="offering_assignments"),
    url(r'^class/(?P<course_sec_id>[\d]+)/participants$', 'offering_participants', name="offering_participants"),
    url(r'^class/(?P<course_sec_id>[\d]+)/materials$', 'offering_materials', name="offering_materials"),
    url(r'^class/(?P<course_sec_id>[\d]+)/library$', 'offering_library', name="offering_library"),
