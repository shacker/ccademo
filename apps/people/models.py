...
class ActiveProfileManager(models.Manager):
    ...
    def get_queryset(self):
        return super(ActiveProfileManager, self).get_queryset().filter(user__is_active=True)
...
class ActiveProfileAlumniManager(models.Manager):
    ...
    def get_queryset(self):
        return super(ActiveProfileAlumniManager, self).get_queryset().filter(
...
class ExtendActiveManager(models.Manager):
    ...
    def get_queryset(self):
        return super(ExtendActiveManager, self).get_queryset().filter(profile__user__is_active=True)
